# Архитектура FinPlus - Финансовый Пульсометр
...
**FinPlus** — мультибанковское приложение для управления личными финансами с проактивным мониторингом финансового здоровья.
